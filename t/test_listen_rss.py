...
from listen_rss import Checker
...
class TestClass:
    def setUp(self):
        self.session = get_session(':memory:')
        self.checker = Checker(self.session, MagicMock(), MagicMock(), 15)
    ...
    def test_checker(self):
        ...
        assert not self.checker.bot.post.called
